...
public final class MatrixToImageWriter {
  ...
  /**
   * @deprecated use {@link #writeToPath(com.google.zxing.common.BitMatrix, String, java.nio.file.Path)}
   */
  @Deprecated
  ...
  /**
   * @deprecated use {@link #writeToPath(com.google.zxing.common.BitMatrix, String, java.nio.file.Path, MatrixToImageConfig)}
   */
  @Deprecated
